...
function App() {
  ...
  const [input, setinput] = useState("Taj Mahal");
    ...
    <>
      ...
      <nav className="bg-transparent ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a className='text-white' href="https://www.instagram.com/tharun_ravuru/" target='_blank' rel="noreferrer">

            <span className="self-center text-sm font-semibold whitespace-nowrap">Made with 💓 by Tharun..</span>
          </a>
          <a href='https://github.com/THARUN2939' target='_blank' rel="noreferrer" className='bg-gray-100 p-2 rounded text-black flex justify-center items-center gap-1'> <span className='text-lg'><FaGithub /></span> Source code</a>
        </div>
      </nav>

      <div className='flex flex-col gap-1 lg:pt-0 pt-12'>
        <h1 className=' animate-text bg-gradient-to-r from-pink-600 via-yellow-500 to-orange-500 bg-clip-text text-transparent lg:text-5xl md:text-6xl text-5xl font-black p-1'>PicGenius AI</h1>
